...
This ensures that every team member or AI assistant working on the project has immediate access to all project skills directly inside the repository without relying on external or cloud AI configurations.
